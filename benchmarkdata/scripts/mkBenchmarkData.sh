...
for i in {1..6} 8 9 12; do if [ ! -e "../f${i}.txt" ];               then python mkBenchmarkData.py -c -o ../f${i}.txt                         -n 1000   -r 0                        -f ${i}; fi done
for i in {1..6} 8 9 12; do if [ ! -e "../f${i}_noisepct10-1.txt" ];  then python mkBenchmarkData.py -c -o ../f${i}_noisepct10-1.txt            -n 1000   -r $(bc -l <<< "10 ^(-1)")  -f ${i}; fi done
for i in {1..6} 8 9 12; do if [ ! -e "../f${i}_noisepct10-3.txt" ];  then python mkBenchmarkData.py -c -o ../f${i}_noisepct10-3.txt            -n 1000   -r $(bc -l <<< "10 ^(-3)")  -f ${i}; fi done
for i in {1..6} 8 9 12; do if [ ! -e "../f${i}_noisepct10-6.txt" ];  then python mkBenchmarkData.py -c -o ../f${i}_noisepct10-6.txt            -n 1000   -r $(bc -l <<< "10 ^(-6)")  -f ${i}; fi done
for i in {1..6} 8 9 12; do if [ ! -e "../f${i}_noisepct10-9.txt" ];  then python mkBenchmarkData.py -c -o ../f${i}_noisepct10-9.txt            -n 1000   -r $(bc -l <<< "10 ^(-9)")  -f ${i}; fi done
for i in {1..6} 8 9 12; do if [ ! -e "../f${i}_test.txt" ];          then python mkBenchmarkData.py -c -o ../f${i}_test.txt          -s 9999   -n 100000 -r 0                        -f ${i}; fi done
