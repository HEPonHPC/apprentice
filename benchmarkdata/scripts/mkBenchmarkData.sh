...
for i in {1..6} 8 9; do if [ ! -e "../f${i}_noise_0.1.txt" ];      then python mkBenchmarkData.py -c -o ../f${i}_noise_0.1.txt              -n 1000   -r 0.1 -f ${i}; fi done
for i in {1..6} 8 9; do if [ ! -e "../f${i}_noise_0.5.txt" ];      then python mkBenchmarkData.py -c -o ../f${i}_noise_0.5.txt              -n 1000   -r 0.5 -f ${i}; fi done
...
for i in 10; do if [ ! -e "../f${i}_noise_0.1.txt" ];      then python mkBenchmarkData.py -c -o ../f${i}_noise_0.1.txt              -d 4 -n 1000   -r 0.1 -f ${i}; fi done
for i in 10; do if [ ! -e "../f${i}_noise_0.5.txt" ];      then python mkBenchmarkData.py -c -o ../f${i}_noise_0.5.txt              -d 4 -n 1000   -r 0.5 -f ${i}; fi done
